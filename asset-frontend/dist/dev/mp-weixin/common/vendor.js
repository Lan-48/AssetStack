...
if (!Math) {
  "../pages/asset/list/asset-list-page.js";
  "../pages/asset/detail/asset-detail-page.js";
  "../pages/wardrobe/list/wardrobe-list-page.js";
  "../pages/setting/setting-page.js";
}
const _sfc_main$2 = {};
function _sfc_render(_ctx, _cache) {
  return {};
}
const App$1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render]]);
function createApp() {
  const app = createSSRApp(App$1);
  return {
    app
  };
}
    ...
    index.request({
      ...
      success: (res) => {
        ...
        if (res.statusCode === 200) {
          ...
          index.showToast({ title: "登录已过期", icon: "none" });
          index.redirectTo({ url: "/pages/login/login" });
          reject(res);
        } else {
          index.showToast({ title: ((_a = res.data) == null ? void 0 : _a.message) || "请求失败", icon: "none" });
          reject(res);
        }
      },
      fail: (err) => {
        index.showToast({ title: "网络错误", icon: "none" });
        reject(err);
      }
    });
  });
...
const fetchAssetList = (params) => {
  return request.get("/asset/list", { params });
};
const calculateDaysBetween = (startDate, endDate = /* @__PURE__ */ new Date()) => {
...
const calculateDaysToNow = (date) => {
  return calculateDaysBetween(date, /* @__PURE__ */ new Date());
};
...
function getCurrency() {
  const saved = index.getStorageSync("currency") || "CNY";
  return saved;
}
...
exports.calculateDaysToNow = calculateDaysToNow;
exports.computed = computed;
exports.createApp = createApp;
exports.defineComponent = defineComponent;
exports.e = e;
exports.f = f;
exports.fetchAssetList = fetchAssetList;
